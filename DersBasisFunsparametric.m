function ndersparametric = DersBasisFunsparametric(spannumber,u,p,du,U)
...
for k=2:du+1
    for j=1:p+1
        ndersparametric(k,j) =ndersparametric(k,j)* r;
    end
    r =r* (p+1-k);
end
